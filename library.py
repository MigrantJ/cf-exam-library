...
class Library(object):
    ...
    def add_shelves(self, *args):
        ...
        for shelf in args:
            ...
            if shelf_key not in self._shelves:
                ...
                print(u"Cannot add '{shelf}': shelf already exists!"
    ...
    def get_shelf(self, shelf_name):
        ...
        try:
            ...
            print(u"Shelf named {shelf} not found in {library}"
    ...
    def report_all_books(self):
        ...
        print(u"= All Books at {library} =".format(library=self))
        print(u"+ {:^30} | {:^30} | {:^10} +"
              .format(u"Title", u"Author", u"Copies"))
        for shelf in self._shelves.itervalues():
            print(u"Shelf - {shelf}".format(shelf=shelf))
            shelf.report_books()
...
class Shelf(object):
    ...
    def get_book(self, title):
        ...
        if title in self._books:
            ...
            print(u"{title} not found in {shelf}!"
...
class Book(object):
    ...
    def report_copies(self):
        ...
        print(u"{title} now has {copies} copies."
    ...
    def check_out(self):
        ...
        if self._copies:
            ...
            print(u"Cannot check out {title}: no more copies!"
    ...
    def check_in(self):
        ...
        if self._copies < self._maxcopies:
            ...
            print(u"All copies of {title} already accounted for!"
                  .format(title=self.title))


if __name__ == "__main__":
    # Create a library with a name
    library = Library(u"Bellevue Public Library")

    # Shelves can be created as their own instances...
    shelf1 = Shelf(u"Fantasy")
    shelf2 = Shelf(u"Science Fiction")

    # ... or by passing a string to the library's add method
    library.add_shelves(shelf1, shelf2, u"Boring Adult Stuff")

    # A book can be created with all information up front
    book1 = Book(title=u"A Game of Thrones",
                 author=u"George R. R. Martin",
                 page_count=864,
                 desc=u"Here is the first volume in George R. R. Martin's "
                      u"cycle of novels that includes A Clash of Kings and A "
                      u"Storm of Swords.",
                 copies=2)

    # Or just with a title
    book2 = Book(u"The Lord of the Rings")

    # Like shelves, a string passed to the add method will also create a book
    shelf1.add_books(book1, book2, u"The Scar")

    # A book can be retrieved at the shelf level
    book3 = shelf1.get_book(u"The Scar")

    # Which allows the book's information to be added / updated later
    book3.author = u"China Miéville"
    book3.page_count = 608
    book3.description = (u"In the third book in an astounding, genre-breaking "
                         u"run, China Mieville expands the horizon beyond the "
                         u"boundaries of New Crobuzon, setting sail on the "
                         u"high seas of his ever-growing world of Bas Lag.")
